...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                CityTextView(cityName: "Colombo, SL")
...
struct BackgroundView: View {
    ...
    var body: some View {
        LinearGradient(gradient: Gradient(colors: [isNight ? .black: Color.blue, isNight ? .gray : Color("lightBlue")]), startPoint: .topLeading, endPoint: .bottomTrailing).ignoresSafeArea()
    }
}
